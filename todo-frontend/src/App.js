    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          <Route path="/login" element={isAuthorized ? <Navigate to="/"/>:<Login apis= {APIS} setToken={setToken} token={token} isAuthorized={isAuthorized} />}/>
          <Route path="/signup" element={<SignUp apis={APIS}/>}/>
        </Routes>
      </div>
    </Router>
  );
